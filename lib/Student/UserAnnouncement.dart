...
String StrUser;
class UserAnnouncemntlist extends StatefulWidget {
  @override
  final UserType User;

  UserAnnouncemntlist({Key key, @required this.User}) : super(key: key);
  _UserAnnouncemntlistState createState() => _UserAnnouncemntlistState(User);
}

class _UserAnnouncemntlistState extends State<UserAnnouncemntlist> {
  UserType User;
  String _searchText = "";
  bool _saving = true;
  ...
  _UserAnnouncemntlistState(this. User) {
    _filter.addListener(() {
