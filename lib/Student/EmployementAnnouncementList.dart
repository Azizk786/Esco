...
String StrUser;
class EmployeeAnnouncemntlist extends StatefulWidget {
  @override
  final UserType User;

  EmployeeAnnouncemntlist({Key key, @required this.User}) : super(key: key);
  _EmployeeAnnouncemntlistState createState() => _EmployeeAnnouncemntlistState(User);
}

class _EmployeeAnnouncemntlistState extends State<EmployeeAnnouncemntlist> {
  UserType User;
  String _searchText = "";
  bool _saving = true;
  ...
  Future<List> getinformation() async {
    final String url = API.Base_url + API.getUserAnnouncement;
  ...
  _EmployeeAnnouncemntlistState(this. User) {
    _filter.addListener(() {
                  ...
                  Container(
                    ...
                    child: FlatButton(
                      onPressed: () {
                        Navigator.push(
                            context,
                            MaterialPageRoute(builder: (context) => MentorAnnouncemntDetail(StrUserType: User, map: _FilterannouncementList[index])));
