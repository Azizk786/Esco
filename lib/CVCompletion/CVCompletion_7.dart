...
class CVCompletion_7 extends StatefulWidget {
  @override
  UserType  StrUserType;
  CVCompletion_7({Key key, @required this.StrUserType}) : super(key: key);
  _CVCompletion_7State createState() => _CVCompletion_7State(StrUserType);
}

class _CVCompletion_7State extends State<CVCompletion_7> {
  UserType  StrUserType;
  String struserid;
  bool _saving = false;
  Map userdata;
  ...
  bool createPayload()
  {
    if(_descr.text.length <1) {
      ...
      showMyDialog(context,"Competente de comunicare");
      return false;
    }
    _cv7 = {
  ...
  Future<Null> GetCVPlandata() async
  {
    ...
    plandata = json.decode(
        sem_data["competente_comunicare"].replaceAll(new RegExp(r"(\s\n)"), ""));
            ...
            child: Column(
              children: <Widget>[
                ...
                Text(
                    "Pasul 7 din 13",
                    style:
                    TextStyle(color: Colors.grey, fontSize: 18.0, fontFamily: 'regular')
                ),
                SizedBox(height: 10,),
                Text(
                ...
                Container(
                  ...
                  child: Column(
                    ...
                    children: <Widget>[
                      ...
                      SizedBox(height: 10,),
                      TextFormField(
style: TextStyle(color: Colors.black54, fontSize: 18.0, fontFamily: 'demi'),maxLines: 6,controller: _descr,textAlign: TextAlign.left),
                  ...
                  child: Stack(
                    children: <Widget>[
                      Align(
                          ...
                          child: Text(
                              "Salvați și mergeți la pasul 8", style: TextStyle(fontFamily: 'regular')
                          )
                      )
                    ],
                  ),
