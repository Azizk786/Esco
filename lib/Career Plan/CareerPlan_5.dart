...
class CareerPlan_5 extends StatefulWidget {
  @override
  UserType  StrUserType;
  CareerPlan_5({Key key, @required this.StrUserType}) : super(key: key);
  _CareerPlan_5State createState() => _CareerPlan_5State(StrUserType);
}

class _CareerPlan_5State extends State<CareerPlan_5> {
  double _value = 0.7;
  UserType  StrUserType;
 // Map _payload;
  _CareerPlan_5State(this.StrUserType);
  @override
  String struserid;
  ...
  SaveCreerPlan_oportunitati() async {
    ...
    prefs.setString("CP5", json.encode(_cp5));
  }
...
//    }
    ...
    /*
    {"1531295447312":{"
    obstacole":"Concurenti cu experienta, abilitati si cunostine superioare",
    "schimbari":"Tendinte negative in domeniu, ce vor duce la diminuarea locurilor de munca",
    "resurse":"Resursele materiale","
    alteAmenintari":[]}}
      * */

    Map Sem_Payload =  {
      "obstacole":_q1.text.toString(),
      "schimbari":_q2.text.toString(),
      "resurse":_q3.text.toString(),
      "alteAmenintari":arr,
    };

    _cp5 = {
      "1531295447312":Sem_Payload,
    };
  ...
  Future<Null> GetCVPlandata1() async
  {
    ...
    Map plandata = json.decode(
        sem_data["amenintari"].replaceAll(new RegExp(r"(\s\n)"), ""));


    setState(() {
      _q1.text = plandata["1531295447312"]["obstacole"];
      _q2.text = plandata["1531295447312"]["schimbari"];
      _q3.text = plandata["1531295447312"]["resurse"];

     // List alte = plandata["1531295447312"]["alteAmenintari"].split(",");
      List telefon = plandata["1531295447312"]["alteAmenintari"];
      print("ppppp = $telefon");
    ...
    if(rowCount-1 == _inx)
    {
      return TextFormField(
        ...
        decoration: InputDecoration(
            labelText: 'Adauga alte oportunitati',
            ...
            child: Column(
                ...
                children: <Widget>[
                  ...
                  Column(
                    ...
                    children: <Widget>[
                      Text("Care sunt obstacolele existente în calea carierei propuse?",
                          style:
                          TextStyle(color: Colors.grey, fontSize: 16.0, fontFamily: 'regular')),
                      TextFormField(
                        maxLines: 5,
                      ...
                      SizedBox(height: 20,),
                      Text("Care sunt schimbările socio-economice care pot afecta evoluţia în carieră?",
                          style:
                          TextStyle(color: Colors.grey, fontSize: 16.0, fontFamily: 'regular')),
                      TextFormField(
                        maxLines: 5,
                      ...
                      SizedBox(height: 20,),
                      Text("Care dintre resursele necesarare s-ar putea epuiza / ar dispărea?",
                          style:
                          TextStyle(color: Colors.grey, fontSize: 16.0, fontFamily: 'regular')),
                      TextFormField(
                        maxLines: 5,
                  ...
                  RaisedButton(
                    ...
                    onPressed: (){
                      ...
                      if(StrUserType == UserType.Student || StrUserType == UserType.Pupil)
                      {
                        if (createPayload() == true)
                        {
//                          _apiTo_addCareerPlan5().then((res) {
//                            if (res == true)
//                            {
                              setState(() {
