...
class userinformation extends StatefulWidget {
  ...
  @override
  _userinformationState createState() => _userinformationState(User);
}
    ...
    if (!(_searchText.isEmpty)) {
      ...
      for (int i = 0; i < _FilterinformationList.length; i++) {
        if (_FilterinformationList[i]['titlu'].toLowerCase().contains(
            ...
            _FilterinformationList[i]['descriere'].toLowerCase().contains(
                _searchText.toLowerCase())) {
...
//                            MaterialPageRoute(builder: (context) => informationDetails(StrUserType: User, map: _FilterinformationList[index])));
                        ...
                        Navigator.push(
                            context,
                            MaterialPageRoute(builder: (context) => AddInformation(User: User,forEdit: true, mdata: _FilterinformationList[index])));
